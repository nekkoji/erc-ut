...
from ui_pages.earmark_page import Earmark_Monitoring
...
class PDFUtilityTool(QMainWindow):
    ...
    def setup_main_app(self):
        ...
        self.pages["earmark"] = Earmark_Monitoring(self.switch_page)
    ...
    def go_back(self):
        if self.main_window:
            self.main_window.set_page("home")  # Or whatever your main page key is
